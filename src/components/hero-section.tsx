  ...
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="pointer-events-none absolute inset-0">
        ...
        <div className="absolute right-0 top-20 h-[300px] w-[400px] rounded-full bg-blue-500/5 blur-3xl" />
      </div>
      ...
      <div className="relative mx-auto max-w-6xl px-6 pb-20 pt-24 md:pt-32">
        ...
        {/* Mode toggle */}
        <div className="mx-auto mt-8 flex max-w-xs items-center justify-center gap-1 rounded-lg border border-border/60 bg-card/50 p-1">
          <button
            onClick={() => setMode("url")}
        ...
        <div className="mx-auto mt-6 max-w-2xl">
          {mode === "url" ? (
            <div className="group relative">
              <div className="absolute -inset-1 rounded-2xl bg-gradient-to-r from-emerald-500/20 via-emerald-500/10 to-blue-500/20 opacity-0 blur-lg transition-opacity duration-500 group-focus-within:opacity-100" />
              <div className="relative flex items-center gap-2 rounded-xl border border-border/80 bg-card p-2 shadow-2xl shadow-black/20 transition-colors group-focus-within:border-emerald-500/40">
            ...
            <div className="group relative">
              <div className="absolute -inset-1 rounded-2xl bg-gradient-to-r from-emerald-500/20 via-emerald-500/10 to-blue-500/20 opacity-0 blur-lg transition-opacity duration-500 group-focus-within:opacity-100" />
              <div className="relative rounded-xl border border-border/80 bg-card p-4 shadow-2xl shadow-black/20 transition-colors group-focus-within:border-emerald-500/40">
                <Textarea
          ...
          {mode === "url" && (
            <div className="mt-4 flex flex-wrap items-center justify-center gap-2 text-xs text-muted-foreground">
              ...
              {["OLX", "ZAP Imóveis", "QuintoAndar", "ImovelWeb"].map((site) => (
                <button
                  key={site}
                  className="rounded-md border border-border/60 px-2.5 py-1 transition-colors hover:border-emerald-500/40 hover:text-emerald-400"
                  onClick={() =>
